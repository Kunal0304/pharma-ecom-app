...
// Auth Login Method
const postRegister = data => post(url.BASE_URL+url.POST_AUTH_REGISTER, data);
...
export const saveSellerShopBankDetail = bank => post(url.BASE_URL+url.SAVE_SELLER_SHOP_BANK,bank);
